...
Production walk-forward Ridge regression signal combiner.

This module complements src/signal/combiner.py. It reads
...
This is the canonical implementation used by the production pipeline.
