...
| ablation_no_piotroski_f | 消融实验 | 0.524 | — | — | — |
| ablation_no_high_52w_v2 | 消融实验 | 0.423 | — | — | — |
| ablation_no_piotroski_high52w | 消融实验 | 0.430 | — | — | — |
...
| 问题 | 级别 | 状态 |
|------|------|------|
| piotroski_f 因子方向疑似反转 | 中 | **已确认 REMOVE_CANDIDATE（2026-05-29）**。2021-2022 出现方向反转，前 9 年有效，风格周期假说成立；消融实验确认剔除后 IR=0.524（提升）；诊断报告：`check/0529/piotroski_diagnosis.md` |
...
| piotroski_f 诊断完成（REMOVE_CANDIDATE）| 2026-05-29 | `check/0529/piotroski_diagnosis.md` |
| 消融实验完成（ablation_no_piotroski_f IR=0.524）| 2026-05-29 | `registry/challengers.json` |
