...
> **测试集**：2023-2025（受保护，剩余2次机会，本文档所有分析不触碰）  
> **生成日期**：2026-05-28
...
*本文档基于 2026-05-28 时点的因子池状态编写。所有分析均在训练期（2012-2020）和验证期（2021-2022）范围内进行，严格遵守测试集保护原则（2023-2025，剩余 2 次机会）。新因子的实际性能以入池测试结果为准，本文档中的预期 IC_IR 和改进幅度均为基于学术文献的先验估计。*
